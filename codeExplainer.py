...
def show(api_key=None):
    ...
    if api_key:
        ...
        if exampleCode:
            ...
            st.warning("Palm API may have some trouble generating the visual explanation. Please try again later. This functionality works best with OPEN AI's mermaid generated code.")
    else:

...
def show():
    ...
    * **Translate Your Code**: Translate code between different programming languages.
    ...
    st.markdown("""
    Code Buddy was conceptualized and developed by [Shiva Kumar](https://github.com/ShivaKumar8037), aimed at providing an intuitive and efficient coding experience.
                 Check out the project on [GitHub](https://github.com/ShivaKumar8037/Code_buddy) for more details, contributions, and updates.
    """)
